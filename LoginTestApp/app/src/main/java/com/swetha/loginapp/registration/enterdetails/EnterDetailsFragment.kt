package com.swetha.loginapp.registration.enterdetails
...
import com.swetha.loginapp.registration.RegistrationViewModel
            ...
            Observer<EnterDetailsViewState> { state ->
                when (state) {
                    is EnterDetailsSuccess -> {
                        ...
                        (activity as RegistrationActivity).onLoginSuccess()
                    }
