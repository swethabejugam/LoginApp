...
import com.swetha.loginapp.LiveDataTestUtil
...
class LoginViewModelTest {
    ...
    fun `Login emits success`() {
        ...
        assertEquals(LiveDataTestUtil.getValue(viewModel.loginResult), `Login emits success`())
    }
    ...
    fun `Login emits error`() {
        ...
        assertEquals(LiveDataTestUtil.getValue(viewModel.loginResult), `Login emits error`()/*LoginError*/)
    }
